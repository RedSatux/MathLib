<template>
    <main id="site-main" class="site-main outer">
        <div class="inner">
            <article class="post-full" :class="{ 'no-image': !this.current.image }">
                ...
                <figure v-if="this.current.image" class="post-full-image" :style="backgroundImage"></figure>
...
<script>
    ...
    export default {
        computed: {
            ...
            datetime() {
                return moment(this.current.publish).locale('fa').format('YYYY/M/D')
            },
            localeDate() {
                return moment(this.current.publish).locale('fa').format('YYYY/M/D')
            },
